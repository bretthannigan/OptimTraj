function [dState, dStateGrad] = dynamics_OpenSim(time,state,control,p,model)
% [dState, dStateGrad] = dynamics_OpenSim(time,state,control,p,model)
%
% Computes the first-order dynamics of an OpenSim model.
%
% INPUTS:
%   time = 
